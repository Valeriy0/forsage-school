    ...
    <div className="flex justify-between max-w-[1200px] w-full space-x-[100px] sm:flex-col-reverse sm:w-full sm:space-x-0 sm:text-center ">
      ...
      <div className="flex-1 flex flex-col pt-16">
        <div className="flex flex-col space-y-5 mb-10">
          ...
          <span className="text-xl font-semibold font-montserrat hover:underline">
            <a href="https://support.forsage.io/article/guides/xqore" target="_blank"> 
              xQore PDF presentations
            </a>
            </span>
        </div>
