  ...
  return (
        <div className="flex flex-col items-center justify-center pt-[200px] w-full">
            <div className=" flex flex-col items-center justify-center space-y-7">
                <span className="text-5xl text-center font-bold sm:text-4xl">Installing a wallet <br className="hidden sm:flex"/> on your <br className="sm:hidden"/> smartphone or computer</span>
