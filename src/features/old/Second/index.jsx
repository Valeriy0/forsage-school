...
export const Second = () => {
  ...
  return (
    <div className="flex flex-col min-h-[800px] sm:min-h-[450px] justify-center items-center w-full max-w-[1400px] sm:max-w-[full]" style={wrapperStyle}>
      <div className="flex flex-col justify-center items-center w-full max-w-[920px] sm:max-w-full font-semibold text-3xl sm:text-xl text-center px-4 space-y-[150px] sm:space-y-[25%]">
