...
export const FirstTest = ({nextSlide}) => {
    ...
    return(
        <div className="bg-[#14191B] rounded-[20px] px-[100px] py-[50px] flex flex-col items-center justify-start min-h-[700px] h-full space-y-9 sm:px-3 w-content sm:min-w-full ">
