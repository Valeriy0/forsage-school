...
export const InstallWallet = () => {
  ...
  return (
        <div className="flex flex-col items-center justify-center pt-[200px] sm:pt-[120px] w-full relative">
             <img className="absolute top-0 z-[-1] w-full sm:top-12 " src="/img/onePager/bg.png"/>
            <div className=" flex flex-col items-center justify-center space-y-7 sm:px-4">
            ...
            <div className="mt-[70px] flex space-x-12 sm:px-4 sm:flex-col sm:space-x-0 sm:w-full sm:space-y-9">
                <div className="bg-[#14191B] py-5 px-18 rounded-[25px]  flex flex-col items-center space-y-6">
                    ...
                    <img className="w-[200px] " src="/img/wallets/TP.png"/>
                ...
                <div className="bg-[#14191B] py-5 px-18 rounded-[25px]  flex flex-col items-center space-y-6">
                    ...
                    <img className="w-[200px] " src="/img/wallets/Metamask.png"/>
