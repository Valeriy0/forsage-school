...
export const FirstBlock = ({firstTitle, secondTitle, title, img, desc, desc2}) => {
    ...
    return (
        <div className="bg-[#14191B] rounded-[20px] px-[100px] py-[50px] flex items-center justify-between min-h-[700px] h-full sm:min-h-full sm:px-0 sm:flex-col sm:space-y-9">
