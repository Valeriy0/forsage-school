...
export const InvitePartners = () => {
  ...
  return (
    <div className="relative flex flex-col items-center w-full pb-[100px]">
      <img className="absolute left-0 top-0" src="/img/invitePartners/left.png" alt="" />
      <img className="absolute right-0 bottom-0" src="/img/invitePartners/right.png" alt="" />
      <div className="max-w-[866px] w-full flex flex-col items-center">
        ...
        <div className="flex flex-col space-y-5 z-10">
          {info.map((item, itemIndex) => {
            return (
              <div className="flex items-center justify-start space-x-10 px-10 py-[30px] bg-[#0E0E0F] border border-white-100 rounded-[30px]" key={itemIndex}>
