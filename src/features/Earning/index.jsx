...
export const Earning = () => {
  ...
  return (
        <div className="flex flex-col items-center space-y-14 pt-[50px] w-full sm:space-y-0">
            ...
            <div className=" flex items-start justify-between w-full ">
                ...
                <div className=" flex flex-col relative items-center">
                    <div className="bg-[#14191B] rounded-[30px] border border-1 py-11 px-[50px] flex flex-col items-center space-y-7 mt-[50px] relative sm:top-[50px] sm:px-5 sm:py-5">
                    ...
                    <div className="w-11/12 h-[200px] border rounded-[30px] absolute top-[180px] sm:top-[285px] z-[-10] px-20 bg-[#14191B]"></div>
                    <div className="w-9/12 h-[200px] border rounded-[30px] absolute top-[200px] sm:top-[305px] z-[-15] px-20 bg-[#14191B]"></div>
                </div>
