...
export const Earning = ({ id, title, testContent }) => {
  ...
  return (
        <div id={`recap-${id}`} className="flex flex-col justify-center items-center space-y-14 pt-[50px] pb-[100px] w-full sm:space-y-0">
            ...
            <div className=" flex items-start justify-center w-full sm:w-full ">
                <img className="absolute w-[55vh] z-[-20] left-0 sm:hidden" src="/img/earning/gamepad.png" />
                ...
                <img className="absolute w-[55vh] right-0 z-[-20] sm:hidden" src="/img/earning/secondPic.png" />
            </div>
        </div>
  )
}