...
export const Steps = () => {
    return (
        <div className="flex flex-col items-center justify-center space-y-11 pt-[200px] w-full">
            ...
            <div className="opacity-50 space-y-5 flex flex-col items-center justify-center px-4 max-w-[850px] w-full">
                <div className="bg-[#0E0E0F] rounded-[20px] pl-9 pr-6 py-4 border border-1 border-white-100 flex flex-row  right-0 justify-between max-w-[54.25%] w-full sm:max-w-full mr-auto">
                    <span className="text-white-500">Account registartion</span>
                    <div className="rounded-full bg-[#4D4D4D] p-3"></div>
                </div>
                <div className="bg-[#0E0E0F] rounded-[20px] pl-6 pr-9 py-4 border border-1 border-white-100 flex flex-row  justify-between  max-w-[54.25%] w-full sm:max-w-full ml-auto">
                    <div className="rounded-full bg-[#4D4D4D] p-3"></div>
                    <span className="text-white-500">Personal verification</span>
                </div>
                <div className="bg-[#0E0E0F] rounded-[20px] pl-9 pr-6 py-4 border border-1 border-white-100 flex flex-row left-0 justify-between max-w-[54.25%] w-full sm:max-w-full mr-auto">
                ...
                <div className="bg-[#0E0E0F] rounded-[20px] pl-6 pr-9 py-1 border border-1 border-white-100 flex flex-row  items-center justify-between max-w-[54.25%] w-full sm:max-w-full ml-auto">
                    <div className="rounded-full bg-[#4D4D4D] p-3"></div>
